...
class userController extends Controller
{
    ...
    public function getNewUser() {
        ...
        return view('dashboards.general.newUser', compact('user','roles'));
    }
    ...
    public function showPass($id, $tempPass){
        ...
        return view('dashboards.general.showPass', compact('user', 'password'));
    }
    ...
    public function sysUsers(){
        ...
        return view('dashboards.general.allUsers', compact('users'));
    }
    ...
    public function getUpdateUser($id){
        ...
        return view('dashboards.general.updateUser', compact('user', 'userRoles', 'roles'));
    }
